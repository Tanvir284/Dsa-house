...
// Canonical ids now live in `@/data/category-ids` so the light catalogue can
// reference them without pulling this module's lesson content. Re-exported
// here because the whole curriculum tree already imports them from this path.
